...
<body class="bg-gray-100 min-h-screen">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <div class="px-5 pb-5">
                        <button onclick="openPaymentModal('{{ $subpackage->title }}', {{ $subpackage->offer_price }})"
    ...
    <div id="paymentModal" class="fixed inset-0 bg-black/50 hidden flex items-center justify-center z-50 p-4">
        <div class="bg-white rounded-3xl shadow-2xl w-full max-w-md p-6 relative">
            ...
            <!-- Modal Title -->
            <h2 id="modalPackageTitle" class="text-2xl font-bold text-gray-800 mb-4 text-center"></h2>
    ...
    <script>
        ...
        document.getElementById('paymentForm').addEventListener('submit', function(e) {
            ...
            console.log('Package:', document.getElementById('modalPackageTitle').textContent);
