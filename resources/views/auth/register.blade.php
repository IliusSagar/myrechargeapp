            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required autofocus
                        ...
                        class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-orange-500 focus:outline-none">
                    @error('name')
                ...
                <div class="flex items-center justify-between">
                    ...
                    <button type="submit"
                        class="px-6 py-2 bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 hover:from-orange-600 hover:via-orange-700 hover:to-orange-800 text-white rounded-lg font-semibold transition">
                        Register
                    </button>
                </div>
    ...
    <footer class="py-6 text-center">
        <div class="flex justify-center space-x-5">
            ...
            <a href="{{ $appSetup->facebook ?? '#' }}" target="_blank"
                class="w-10 h-10 flex items-center justify-center rounded-full bg-white/20 text-white hover:bg-gradient-to-r from-orange-500 to-orange-600 hover:scale-110 transition duration-300">
